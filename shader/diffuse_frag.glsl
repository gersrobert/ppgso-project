...
uniform float specularFocus = 0.0;
uniform float specularIntensity = 0.0;
...
void main() {
  ...
  float diffuse = max(dot(inData.normal.xyz, LightDirection), ambientIntensity) * diffuseIntensity;
